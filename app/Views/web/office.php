                ...
                <div class="col sqs-col-12 span-12">
                    <div class="sqs-block image-block sqs-block-image" data-aspect-ratio="42.934782608695656"
                        ...
                        <div class="sqs-block-content">
                            <figure class=" sqs-block-image-figure image-block-outer-wrapper image-block-v2 design-layout-poster combination-animation-fade-in individual-animation-none individual-text-animation-none image-position-left "
                                ...
                                <figcaption class="image-card-wrapper" data-width-ratio>
                                    <div class="image-card sqs-dynamic-text-container">
                                        <div class="image-title-wrapper">
                                            <div class="image-title sqs-dynamic-text" data-animation-override><p
                                                        class="">Profile</p></div>
                                        </div>
                                    </div>
                                </figcaption>
        ...
        <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1666687119489"
            ...
            ">
                        ...
                        <div class="col sqs-col-6 span-6">
                            <div class="sqs-block button-block sqs-block-button" data-block-type="53"
                                ...
                                <div class="sqs-block-content">
                                    ...
                                    >
                                        <a href="<?php echo base_url() ?>/Home/working_at"
                                           class="sqs-block-button-element--medium sqs-button-element--primary sqs-block-button-element">
                                            Working at DA-SEIN </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sqs-block button-block sqs-block-button" data-block-type="53"
                                ...
                                <div class="sqs-block-content">
                                    ...
                                    <div class="sqs-block-button-container sqs-block-button-container--left"
                                         data-animation-role="button" data-alignment="left" data-button-size="medium"
                                         data-button-type="primary">
                                        <a href="<?php echo base_url() ?>/Home/internship_application"
                                           class="sqs-block-button-element--medium sqs-button-element--primary sqs-block-button-element">
                    ...
                    <div class="sqs-block accordion-block sqs-block-accordion" data-block-type="69"
                        ...
                        <div class="sqs-block-content">
                            ...
                            <ul class="accordion-items-container" data-should-allow-multiple-open-items=""
                                data-is-divider-enabled="true" data-is-first-divider-visible="true"
                                data-is-last-divider-visible="true" data-is-expanded-first-item=""
                                data-accordion-title-alignment="left" data-accordion-description-alignment="left"
                                data-accordion-description-placement="left" data-accordion-icon-placement="right">
                                <div class="accordion-divider accordion-divider--top" aria-hidden="true" style="
              height: 3px;
              opacity: 1;
            "></div>
                                <?php foreach ($current_vacancies as $curren){ ?>
          ...
          ">
                                          <span class="accordion-item__title" style="
                                            ...
                                            ">
                                            <?php echo $curren->title;?>
                                          </span>
                                            <div class="accordion-icon-container" data-is-open="false"
            ...
            max-width: 300px;
          ">
                                            <p class=""><?php echo $curren->description?>
                                                <a href="<?php echo base_url() ?>/Home/job_application">APPLY NOW</a></p>
                                        </div>
                                    </div>
            ...
            <div class="row sqs-row">
                <div class="col sqs-col-12 span-12">
                    <div class="sqs-block image-block sqs-block-image" data-aspect-ratio="42.934782608695656"
                        ...
                        <div class="sqs-block-content">
                            <figure class=" sqs-block-image-figure image-block-outer-wrapper image-block-v2 design-layout-poster combination-animation-none individual-animation-none individual-text-animation-none image-position-left "
                                    data-scrolled data-test="image-block-v2-outer-wrapper">
              ...
              ">
                                                ...
                                                <figcaption class="image-caption-wrapper">
                                                    <div class="image-caption"><p class="">
                                                            <strong><?php echo $peo->name; ?></strong><br><?php echo $peo->post; ?>
                                                            <br><a href="mailto:<?php echo $peo->email; ?>"
                                                                   target="_blank"><?php echo $peo->email; ?></a></p>
                                                    </div>
                                                </figcaption>
            ...
            ">
                    ...
                    <?php foreach ($publication as $val) { ?>
                        <div class="row sqs-row">
                            <div class="col sqs-col-6 span-6">
                                <div class="sqs-block image-block sqs-block-image" data-block-type="5"
                                     id="block-yui_3_17_2_1_1615462938338_166789">
                                    <div class="sqs-block-content">
                                        <div class=" image-block-outer-wrapper layout-caption-below design-layout-inline combination-animation-none individual-animation-none individual-text-animation-none"
                                             data-test="image-block-inline-outer-wrapper">
                                            <figure class=" sqs-block-image-figure intrinsic "
                    ...
                    <?php //echo base_url()?><!--/images/image/Web_CoCreation.jpg" data-type="image"/>-->
                    <!--                                                    </div>-->
                    <!--                                                </div>-->
                    <!---->
                    <!--                                            </a>-->
            ...
            <div class="row sqs-row">
                <div class="col sqs-col-12 span-12">
                    <div class="sqs-block image-block sqs-block-image" data-aspect-ratio="41.048824593128394"
                        ...
                        <div class="sqs-block-content">
                            <figure class=" sqs-block-image-figure image-block-outer-wrapper image-block-v2 design-layout-poster image-position-left "
                                    data-scrolled data-test="image-block-v2-outer-wrapper">
    ...
    <section id="events" class="index-page" data-collection-id="614ae2dd4e92bd0f3a9e664b"
        ...
        <div class="sqs-layout sqs-grid-12 columns-12" data-type="page" data-updated-on="1665669032258"
            ...
            ">
                    ...
                    <div class="sqs-block html-block sqs-block-html" data-block-type="2"
                         id="block-yui_3_17_2_1_1648047577354_29084">
                        <div class="sqs-block-content">
                            <h1>Upcoming</h1>
                        </div>
                    </div>
                                        ...
                                        <div class="col sqs-col-4 span-4">
                                            <div class="sqs-block html-block sqs-block-html" data-block-type="2"
                                                ...
                                                <div class="sqs-block-content">
                                                    ...
                                                    <p class=""><a
                                                                href="<?php echo $eve->url; ?>"><strong><?php echo $eve->event_name; ?></strong></a>
                                                    </p>
            ...
            ">
                    ...
                    <?php foreach ($podcasts as $pod) { ?>
                        <div class="sqs-block embed-block sqs-block-embed">
                            <div class="sqs-block-content">
                                <iframe width="100%" height="509"
                                        src="https://www.youtube.com/embed/<?php echo $pod->youtube_url; ?>"
                                        title="Messi Doing Impossible Things" frameborder="0"
                            ...
                            <div class="col sqs-col-3 span-3">
                                ...
                                <div class="sqs-block html-block sqs-block-html" data-block-type="2"
                                    ...
                                    <div class="sqs-block-content">
                                        ...
                                        <p>
                                            <a href="<?php echo $awar->award_title_url; ?>"
                                               target=""><strong><?php echo $awar->award_title; ?></strong></a>
                                            <strong> <br></strong>
                                            <a href="<?php echo $awar->short_title_url; ?>"
                                               target=""><?php echo $awar->short_title; ?></a><br>
                                        </p>
