<!doctype html>
<!-- Created by studiomethod.com.au -->
...
<head>
    ...
    <script>(function (rollups, name) {
            ...
            rollups[name].js = ["//assets.squarespace.com/universal/scripts-compressed/extract-css-runtime-36f1eacd012a4f73874ec-min.en-US.js"];
        })(SQUARESPACE_ROLLUPS, 'squarespace-extract_css_runtime');</script>
    <script src="<?php echo base_url()?>/universal/scripts-compressed/extract-css-runtime-36f1eacd012a4f73874ec-min.en-US.js"></script>
    <script>(function (rollups, name) {
            if (!rollups[name]) {
                rollups[name] = {};
            }
    ...
    <script src="<?php echo base_url()?>/universal/scripts-compressed/common-vendors-96bc8712c3745d2ebe37e-min.en-US.js"></script>
    <script>(function (rollups, name) {
            if (!rollups[name]) {
                rollups[name] = {};
            }
            rollups[name].js = ["//assets.squarespace.com/universal/scripts-compressed/common-e739758b0e95bd9579e23-min.en-US.js"];
        })(SQUARESPACE_ROLLUPS, 'squarespace-common');</script>
    <script src="<?php echo base_url()?>/universal/scripts-compressed/common-e739758b0e95bd9579e23-min.en-US.js"></script>
    <script>(function (rollups, name) {
            if (!rollups[name]) {
                rollups[name] = {};
            }
        ...
        Static.SQUARESPACE_CONTEXT = {
            ...
            "rollups": {
                ...
                "squarespace-dialog": {
                    ...
                    "js": "universal/scripts-compressed/dialog-1637ef455c3cebd1f3931-min.en-US.js"
                },
                ...
                "squarespace-popup-overlay": {
                    ...
                    "js": "universal/scripts-compressed/popup-overlay-d81337754655a7e82426e-min.en-US.js"
                },
            ...
            "website": {
                ...
                "identifier": "DA-SEIN",
                "websiteType": 1,
                "contentModifiedOn": 1667827819202,
                "cloneable": false,
                ...
                "siteTitle": "DA-SEIN",
                "fullSiteTitle": "News",
                "siteDescription": "<p>DA-SEIN is a Copenhagen-based office practicing in the fields of modern architecture, design and visionary urban development and planning.</p><p>Bl\u00E5g\u00E5rdsgade 8, 2. sal, DK-2200 K\u00F8benhavn N, Tlf. (+45) 3535 3631</p>",
                "location": {
                    "mapZoom": 11.0,
                ...
                "shareButtonOptions": {"2": true, "1": true, "4": true},
                "authenticUrl": "#",
            ...
            "betaFeatureFlags": ["crm_retention_segment", "fluid_engine", "commerce_etsy_shipping_import", "viewer-role-contributor-invites", "crm_default_newsletter_block_to_campaigns", "campaigns_content_editing_survey", "campaigns_global_uc_ab", "commerce_etsy_product_import", "send_local_pickup_ready_email", "marketing_landing_page", "fluid_engine_filtered_catalog_endpoints", "asset_uploader_refactor", "member_areas_schedule_interview", "member_areas_spanish_interviews", "campaigns_new_subscriber_search", "commerce_clearpay", "fluid_engine_clean_up_grid_contextual_change", "campaigns_discount_section_in_blasts", "commerce_site_visitor_metrics", "customer_account_creation_recaptcha", "campaigns_asset_picker", "crm_remove_subscriber", "scheduling_block_schema_editor", "customer_accounts_email_verification", "campaigns_new_image_layout_picker", "campaigns_show_featured_templates", "commerce_restock_notifications", "block_annotations_revamp", "block_duplication", "nested_categories_migration_enabled", "crm_use_new_import_modal_profiles", "fluid_engine_block_resizing_indicator", "member_areas_feature", "campaigns_thumbnail_layout", "background_art_onboarding"],
...
<header class="site-header">
    <nav class="site-nav">
        ...
        <div class="nav-container">
            <!-- Desktop  Nav -->
            <ul class="main-nav">
                <li class="<?php echo ($slug == 'news')?'active':''; ?>">
                    <a href="<?php echo base_url()?>/Home/news">News</a>
                </li>
                <li class="<?php echo ($slug == 'work')?'active':''; ?>">
                    <a href="<?php echo base_url()?>/Home/work" >Work</a>
                </li>
                <li class="<?php echo ($slug == 'office')?'active':''; ?>" >
    ...
    <nav class="trans-nav">
        <div class="trans-nav-wrapper ">
            ...
            <ul class="anchor-nav">
                <li>
                    <a class="anchor-btn" href="#profile" title="Profile">Profile</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#contact" title="Contact">Contact</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#employment" title="Employment">Employment</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#people" title="People">People</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#publications" title="Publications">Publications</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#clients" title="Clients">Clients</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#events" title="Events">Events</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#podcasts" title="Podcasts">Podcasts</a>
                </li>
                <li>
                    <a class="anchor-btn" href="#awards" title="Awards">Awards</a>
                </li>
            </ul>
            <?php } ?>

            <?php if ($slug == 'work'){?>
            <form id="category-form" class="category-form" action="<?php echo base_url()?>/Home/category_by_work" method="post">
                <ul class="anchor-nav">
                    <li>
                        <a href="javascript:void(0)" onclick="show_gallery();" style="font-weight: bold;" class="button button__reset active" >view all (<?php echo count($works); ?>)</a>
                    </li>
                    <?php $i=1;$j=1; foreach ($category as $cat){ ?>
                    <li>
                        <div class="form-group form-check">
<!--                            onclick="document.getElementById('form-id').submit();"-->
                            <input type="checkbox" name="category_id[]" onchange="form_submit()" class="form-check-input checkbox" id="exampleCheck_<?php echo $i++?>" value="<?php echo $cat->cat_id?>" >
                            <label class="form-check-label" for="exampleCheck_<?php echo $j++?>"><?php echo $cat->name?></label>
                        </div>
                    </li>
                    <?php } ?>
                    <li>
                        <a href="javascript:void(0)" onclick="show_map();" style="font-weight: bold;" class="button button__map">map</a>
                    </li>
...
<!--                    <dt class="collapsable-list__head">-->
<!--                        <a href="javascript:void(0)" onclick="show_gallery();" style="font-weight: bold;" class="button button__reset active" >view all <span class="counter">--><?php //echo count($works); ?><!--</span></a>-->
<!--                        <a href="javascript:void(0)" onclick="show_map();" style="font-weight: bold;" class="button button__map">map</a>-->
<!--                    </dt>-->
<!--                </dl>-->
<!--            </form>-->
