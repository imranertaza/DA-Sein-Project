<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Internship Application <small>Internship Application List</small></h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-lg-9">
                                <h3 class="box-title">Internship Application List</h3>
                            </div>
                            <div class="col-lg-3">
                            </div>
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped text-capitalize">
                            ...
                            <tbody>
                            <?php $i = 1;
                            foreach ($internship_application as $val) { ?>
                                <tr>
                                    <td><?php echo $i++ ?></td>
                                    ...
                                    <td width="180">
                                        ...
                                        <a href="<?php echo base_url('Admin/Internship_application/view/' . $val->intern_id) ?>" class="btn btn-primary btn-xs">View</a>
